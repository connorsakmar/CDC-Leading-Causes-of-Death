...
server <- function(input, output) {
  ...
  output$conclusions <- renderUI({
    ...
    str6 <- paste("The scatter plot shows some striking trends in the leading causes of death. Seven of the ten causes have generally trended upward since 1999. 
                  ...
                  when they began to slowly trend upwards again.")
    str7 <- paste("Conclusion")
    str8 <- paste("Hopefully you enjoyed looking at this data and that it has encouraged you to look more closely and investigate some of the trends or patterns
                  that you found!")
